    ...
    <section className="card macro-matrix-card">
        <div className="macro-matrix-topline">
          <div>
            ...
            <h2>Industri-PMI faller från höga nivåer</h2>
            <p className="hero-copy compact">
              Separat global PMI-matrix. Den här tabellen är inte ihopblandad med USA Growth Indicators ovan.
            </p>
          </div>
        ...
        <div className="macro-matrix-metric-strip">
          ...
          <div className="macro-mini-stat"><span>PMI-rader live</span><strong>{matrix.availableRowCount ?? 0}/{matrix.totalRowCount ?? 0}</strong></div>
        </div>
