export const CHART_SERIES = Object.freeze({
  ...
  rydObvZscore: Object.freeze({
    key: 'rydObvZscore', dataKey: 'ryd_obv_zscore_80', label: 'RYD Z-score', kind: 'histogram', pane: 2,
  }),
  rydObvRaw: Object.freeze({
    key: 'rydObvRaw', dataKey: 'ryd_obv', label: 'Rå OBV', kind: 'line', pane: 2,
    priceScaleId: 'left', color: '#38bdf8',
  }),
...
export const SIGNAL_KEYS = Object.freeze(['tfSync', 'plceVolumeExtreme']);
...
export const DEFAULT_VISIBLE_SIGNALS = Object.freeze(['tfSync', 'plceVolumeExtreme']);
