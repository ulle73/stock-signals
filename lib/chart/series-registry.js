export const CHART_SERIES = Object.freeze({
  ...
  gexDex: Object.freeze({ key: 'gexDex', label: 'GEX/DEX', kind: 'context', pane: 0, color: '#38bdf8' }),
  gexDexMore: Object.freeze({ key: 'gexDexMore', label: 'Fler nivåer', kind: 'context', pane: 0, color: '#a78bfa' }),
  earnings: Object.freeze({ key: 'earnings', label: 'Rapporter', kind: 'context', pane: 0, color: '#f59e0b' }),
});
...
export const CONTEXT_LAYER_KEYS = Object.freeze(['gexDex', 'gexDexMore', 'earnings']);
...
export const DEFAULT_VISIBLE_CONTEXT_LAYERS = Object.freeze(['gexDex', 'earnings']);
