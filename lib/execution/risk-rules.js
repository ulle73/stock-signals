...
export function evaluateExecutionRiskRules({
  ...
  results.push(
    allowedSymbols.has(normalizedSymbol)
      ? buildResult('allowed_symbols_check', 'pass', 'symbol_not_allowed', 'Symbol is allowed.')
  ...
  results.push(
    isShortIntent
      ? buildResult('long_only_check', 'block', 'short_not_supported', 'Short execution is disabled in v1.')
      : buildResult('long_only_check', 'pass', 'short_not_supported', 'Long-only rule passed.')
  );
