...
export const IMPLIED_VOLATILITY_PROXY_ASSET_DEFINITIONS = [
  ...
  {
    assetKey: 'xlk_technology',
    assetName: 'Technology Select Sector SPDR Fund',
    assetType: 'equity_sector',
    sourceSymbol: 'XLK',
    impliedVolatilitySymbol: '^VXN',
  },
  {
    assetKey: 'xlf_financials',
    assetName: 'Financial Select Sector SPDR Fund',
    assetType: 'equity_sector',
    sourceSymbol: 'XLF',
    impliedVolatilitySymbol: '^VIX',
  },
  {
    assetKey: 'xlv_healthcare',
    assetName: 'Health Care Select Sector SPDR Fund',
    assetType: 'equity_sector',
    sourceSymbol: 'XLV',
    impliedVolatilitySymbol: '^VIX',
  },
