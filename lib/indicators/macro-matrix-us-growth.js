...
function getDefinitionColorConfig(definition) {
  ...
  if (definition.direction === 'lower_is_better') {
    return { type: 'momentum', direction: 'lower_is_better', normalMonthlyMove: 1 };
  }

  if (definition.direction === 'inflation') {
    return { type: 'momentum', direction: 'lower_is_better', normalMonthlyMove: 0.3 };
  }
  ...
  return { type: 'momentum', direction: 'higher_is_better', normalMonthlyMove: 1 };
}
